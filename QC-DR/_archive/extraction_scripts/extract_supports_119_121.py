...
Sheets 119-121: RS13040, RS13050, RS13060 - Interstitial Areas 4-6 Support Plans
"""
...
def main():
    ...
    try:
        ...
        print(f"Drawing Type: Refrigeration Support Plans - Interstitial Areas 4-6")
        print(f"Model: {MODEL}")
