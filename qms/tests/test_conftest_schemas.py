...
def test_schema_order_has_eight_modules():
    """SCHEMA_ORDER should list all 8 modules in FK-dependency order."""
    assert len(SCHEMA_ORDER) == 8
    assert SCHEMA_ORDER[0] == "core"
    assert SCHEMA_ORDER[-1] == "engineering"
