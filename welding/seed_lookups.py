...
PREAPPROVED_COUPONS: List[Tuple[str, str, str, str, str, str, str, int,
    ...
    ("P1", "CS P1 6G GTAW/SMAW — 2\"", "Carbon steel pipe, combo process, all-position",
     "ASME IX", "piping", "GTAW/SMAW", "Carbon Steel (P1)", 1,
     "6G", "WPS-001", "E6010/E7018", "2\" (2.375\" OD)", "", "default"),
    ("P2", "CS P1 6G GTAW/SMAW — 6\"", "Carbon steel pipe, combo process, large diameter",
     "ASME IX", "piping", "GTAW/SMAW", "Carbon Steel (P1)", 1,
     "6G", "WPS-001", "E6010/E7018", "6\" (6.625\" OD)", "", "optional"),
    ("P3", "SS P8 6G GTAW — 2\"", "Stainless steel pipe, GTAW only, all-position",
     "ASME IX", "piping", "GTAW", "Stainless Steel (P8)", 8,
     "6G", "SS-01-P8-GTAW", "ER308L/ER316L", "2\" (2.375\" OD)", "", "default"),
    ("P4", "SS P8 6G GTAW — 6\"", "Stainless steel pipe, GTAW only, large diameter",
     "ASME IX", "piping", "GTAW", "Stainless Steel (P8)", 8,
     "6G", "SS-01-P8-GTAW", "ER308L/ER316L", "6\" (6.625\" OD)", "", "optional"),
    ("P5", "CS P1 6G FCAW-G — 2\"", "Carbon steel pipe, flux-cored gas shielded",
     "ASME IX", "piping", "FCAW-G", "Carbon Steel (P1)", 1,
     "6G", "FCAW-G", "E71T-1", "2\" (2.375\" OD)", "", "default"),
    ("P6", "CS P1 6G FCAW-G — 6\"", "Carbon steel pipe, flux-cored, large diameter",
     "ASME IX", "piping", "FCAW-G", "Carbon Steel (P1)", 1,
     "6G", "FCAW-G", "E71T-1", "6\" (6.625\" OD)", "", "optional"),
    ("P7", "SS P8 Orbital GTAW", "Stainless steel orbital welding per spec",
     "ASME IX", "piping", "GTAW (orbital)", "Stainless Steel (P8)", 8,
